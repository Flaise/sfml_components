...
SpriteHandle MakeSprite(DestroyableHandle destroyable, InterpolandHandle x, InterpolandHandle y, sf::Texture* texture) {
	ReferenceDestroyable(destroyable);
	return sprites.add({destroyable, { x, y }, { 1, 1, 1, 1 }, texture});
}
